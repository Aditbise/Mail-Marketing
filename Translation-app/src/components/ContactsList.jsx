...
export default function ContactsList() {
  ...
  contactIds.forEach((id) => {
    fetch("http://localhost:5678/webhook/05c53425-8a0a-4286-b059-655216aef441", {
      method: "POST",
  ...
  if (contacts.length === 0) return <h2>No valid contacts found</h2>;
    ...
    <div className="contactlistpagediv">
      <div className="contactform">
        <h2>Contacts</h2>
          ...
          {/* <button className="newcontactbutton" onClick={() => navigate("/contact-lists/new-contact")}>New Contact</button> */}
          <button className="newcontactbutton" onClick={()=>setShowQuickAdd(true)}>Quick Add</button> 
